...
export default function MidnightLuxe() {
  return (
    <div style={{ background: BG, color: CREAM, fontFamily: "var(--font-inter), sans-serif", minHeight: "100vh" }}>
      ...
      {/* Nav */}
      <nav style={{ position: "sticky", top: 0, zIndex: 50, background: `${BG}EE`, backdropFilter: "blur(12px)", borderBottom: `1px solid ${GOLD}22` }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", height: 72, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 36, alignItems: "center" }}>
            {["Shop", "About", "Live"].map((item) => (
              <a key={item} href="#" style={{ color: MUTED, fontSize: 13, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", transition: "color 0.2s" }}
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, #0C0C0E 0%, #1A1206 50%, #0C0C0E 100%)` }} />
        ...
        <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto", padding: "0 32px", width: "100%", paddingLeft: "36%" }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <a href="#" style={{ background: GOLD, color: "#0C0C0E", padding: "14px 36px", fontSize: 12, letterSpacing: "0.2em", textTransform: "uppercase", textDecoration: "none", fontWeight: 600, display: "inline-block" }}>
              Shop Collection
            </a>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "120px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 24 }}>
          {products.map((p) => (
            <div key={p.name} style={{ background: DARK_CARD, border: `1px solid ${GOLD}33`, display: "flex", flexDirection: "column", cursor: "pointer" }}
              ...
              <div style={{ height: 280, background: p.gradient, position: "relative" }}>
                <span style={{ position: "absolute", top: 16, left: 16, background: GOLD, color: "#0C0C0E", fontSize: 9, letterSpacing: "0.2em", padding: "4px 10px", fontWeight: 700, textTransform: "uppercase" }}>Handcrafted</span>
              </div>
      ...
      {/* About */}
      <section style={{ background: "#0E0E10", padding: "120px 32px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <blockquote style={{ fontFamily: "var(--font-playfair), serif", fontSize: "clamp(24px, 3.5vw, 44px)", fontStyle: "italic", color: GOLD, lineHeight: 1.5, marginBottom: 40 }}>
            "Every jar is a love letter to your skin — made with intention, care, and the finest ingredients."
          </blockquote>
      ...
      {/* Live Shopping */}
      <section style={{ background: GOLD, padding: "80px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 32, alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "center" }}>
            {["TikTok", "Instagram", "Facebook", "Whatnot"].map((platform) => (
              <a key={platform} href="#" style={{ background: "#0C0C0E", color: GOLD, padding: "10px 20px", fontSize: 12, letterSpacing: "0.1em", textDecoration: "none", fontWeight: 600, whiteSpace: "nowrap" }}>
                {platform}
              </a>
            ))}
          </div>
      ...
      <section style={{ background: BG, padding: "120px 32px", textAlign: "center" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            ...
            />
            <button style={{ background: GOLD, color: "#0C0C0E", border: "none", padding: "14px 0", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", fontWeight: 700, cursor: "pointer" }}>
              Join the Circle
            </button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer style={{ borderTop: `1px solid ${GOLD}22`, padding: "48px 32px" }}>
