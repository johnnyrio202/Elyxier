...
export default function TestimonialsEditor({ testimonials }: { testimonials: Testimonial[] }) {
  ...
  return (
    <section style={{ border: "1px solid var(--admin-border)", borderRadius: 8, background: CARD, padding: 24 }}>
      ...
      {addingNew && (
        <form
          ...
          style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20, paddingBottom: 20, borderBottom: "1px dashed var(--admin-border)" }}
        >
          <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {testimonials.map((tItem, i) => (
          <form key={tItem._id} action={saveTestimonial} style={{ border: "1px solid var(--admin-border-soft)", borderRadius: 6, padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              ...
              <button type="submit" formAction={deleteTestimonial} style={{ ...GHOST_BTN_STYLE, color: "var(--admin-danger)" }}>
                Delete
              </button>
            </div>
          </form>
